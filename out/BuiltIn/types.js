...
exports.structs = exports.classes = exports.floats = exports.integers = void 0;
...
exports.classes = [
    {
        label: "Object",
        description: new vscode_1.MarkdownString("`Object` is the very front-most class which all other classes inherit from, either directly or through other inheriting classes. "),
    },
    {
        label: "ActorIterator",
        description: new vscode_1.MarkdownString("`ActorIterator` is a lighter-in-comparison iterator compared to its brothers, `ThinkerIterator` and `BlockThingsIterator` which is much less resource intensive. However, actors require a TID in order for this to qualify them as part of the iteration. As such, a tid of `0` will not work at all. "),
    },
    {
        label: "AltHud",
    },
    {
        label: "BaseStatusBar",
        description: new vscode_1.MarkdownString("`BaseStatusBar` is the base class that all standard status bars inherit from. It handles drawing the HUD both when the status bar is visible and when the game is running in fullscreen (i.e. the status bar is hidden). It does not handle GZDoom's alternative HUD, however."),
    },
    {
        label: "DoomStatusBar",
    },
    ...
    },
    {
        ...
        description: new vscode_1.MarkdownString("`BlockLinesIterator` is a type of iterator used to search for lines in the `Blockmap`. Contrary to the name, this does not grab only blocking lines but all lines. Instead it gets any line that exists in a blockmap square within the given radius. You can use this to get nearby lines instead of having to iterate through all of them. If you wish to get only blocking lines you'll have to manually check the flags on each line found in the iterator."),
    },
    {
        label: "BlockThingsIterator",
        description: new vscode_1.MarkdownString("`BlockThingsIterator` is a type of iterator used to search for entities that are within the `Blockmap`. This excludes all actors with the `NOBLOCKMAP` flag. Any Actor in a blockmap square within the provided radius is taken, so this does not guarantee they are at radius distance or lower (manual checking will have to be done if a strict distance is necessary). Generally they are best used for getting surrounding Actors within a small area as opposed to every Actor. "),
    },
    {
        label: "Bot",
    },
    ...
    },
    {
        ...
        description: new vscode_1.MarkdownString("Used for interpolating between one value to the next. Can be used to gradually scale the start and end of the approach to and from its destination."),
    },
    {
        label: "HUDFont",
        description: new vscode_1.MarkdownString("This class is used in text-drawing functions as the font to use when drawing text. It also controls how the text is displayed, such as spacing and shadows."),
    },
    {
    ...
    },
    {
        ...
        description: new vscode_1.MarkdownString("Used for showing the inventory items and cycling through them, if they possess `INVENTORY.INVBAR`."),
    },
    {
    ...
    },
    {
        ...
        description: new vscode_1.MarkdownString("Used for interpolating between one value to the next on a linear course."),
    },
    {
    ...
    {
        label: "LineTracer",
        description: new vscode_1.MarkdownString("`LineTracer` is a class that allows for custom ray tracing (aka hitscan) behavior."),
    },
    {
        label: "Menu",
    },
    ...
    {
        label: "Shape2D",
        description: new vscode_1.MarkdownString("`Shape2D` is a class that can be used to create arbitrary flat shapes to be rendered to the screen"),
    },
    {
    ...
    },
    {
        ...
        description: new vscode_1.MarkdownString("Event handler which persist outside of maps but are never saved to savegames"),
    },
    {
        label: "EventHandler",
        description: new vscode_1.MarkdownString("Event handler which is only available within maps but are saved"),
    },
    {
        label: "StatusScreen",
    },
    ...
    {
        label: "Thinker",
        description: new vscode_1.MarkdownString("A `Thinker` class is derived from `Object`, and is used as the base for an Actor and more. Unlike actors, thinkers are not physically present in the game at all."),
    },
    {
        label: "Actor",
        description: new vscode_1.MarkdownString("`Actor` (internally `AActor`) is the base class for all DECORATE actors. When a parent class isn't declared in an actor definition, it uses `Actor` as the parent."),
    },
    {
    ...
    {
        label: "AmbientSound",
        description: new vscode_1.MarkdownString("The `AmbientSound` thing plays an ambient sound determined by its first parameter. The sounds themselves must be defined in `SNDINFO`."),
    },
    {
        label: "AmbientSoundNoGravity",
        description: new vscode_1.MarkdownString("This thing is used like the `AmbientSound` thing in the `UDMF` or `Hexen` map format, but in addition is not affected by gravity and can therefore be placed at specific heights. It plays an ambient sound determined by its first parameter. The sounds themselves must be defined in `SNDINFO`."),
    },
    {
        label: "AmmoFiller",
    },
    ...
    {
        label: "Blood",
        description: new vscode_1.MarkdownString("The blood splat actor is spawned when an actor is hit and is able to bleed."),
    },
    {
        label: "BloodPool",
    },
    ...
    {
        label: "BulletPuff",
        description: new vscode_1.MarkdownString("A puff actor spawned by weapon and monster hitscan attacks (i.e. bullets) in Doom."),
    },
    {
        label: "BurningBarrel",
    },
    ...
    {
        label: "CustomBridge",
        description: new vscode_1.MarkdownString("`CustomBridge` can be used to create either a Doom-style or Hexen-style invisible bridge"),
    },
    {
        label: "Bridge",
        description: new vscode_1.MarkdownString('The bridge is a "3D" element that can be placed at any height and allows players and monsters alike to walk upon it.'),
    },
    {
        label: "ZBridge",
        description: new vscode_1.MarkdownString('The bridge is a "3D" element that can be placed at any height and allows players and monsters alike to walk upon it.'),
    ...
    {
        label: "CustomSprite",
        description: new vscode_1.MarkdownString("Just an actor to make the Build sprites show up."),
    },
    {
        label: "Cyberdemon",
    },
    ...
    {
        label: "Decal",
        description: new vscode_1.MarkdownString("The Decal is a useful tool to add graphics to walls without requiring a custom texture."),
    },
    {
        label: "Demon",
    },
    ...
    },
    {
        ...
        description: new vscode_1.MarkdownString("Doom Builder places this thing on the maps it edits for its 3D editing mode."),
    },
    {
        label: "DoomImp",
    },
    ...
    {
        label: "DynamicLight",
        description: new vscode_1.MarkdownString("The base class for all dynamic lights."),
    },
    {
        label: "PointLight",
    },
